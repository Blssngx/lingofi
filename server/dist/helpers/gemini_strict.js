...
async function strict_output(system_prompt, user_prompt, output_format, default_category = "", output_value_only = false, model = "gemini-1.0-pro-latest", // Adjusted default model to Gemini equivalent
temperature = 1, num_tries = 3, verbose = false) {
    ...
    \nDo not put quotation marks or escape character \\ in the output fields.`;
        ...
        let res = (await result.response).text().replace(/'/g, '"') ?? ""; // Assuming response data structure, adjust as necessary
...
exports.strict_output = strict_output;
