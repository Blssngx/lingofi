...
export default function Dashboard() {
    ...
    const handleSendMessage = (): void => {
        ...
        if (currentInput !== '') {
            const newUserMessage: TextMessage = { type: 'text', text: currentInput, sender: 'user' };
            ...
            setTimeout(() => {
                const newBotMessage: CardMessage = {
                    type: 'card',
                    content: `You said: "${currentInput}". What would you like to do next?`,
                    sender: 'bot',
                    buttonText: 'Respond'
                };
        ...
        <div className="grid h-screen w-full pl-[56px]">
            ...
            <div className="flex flex-col">
                <header className="sticky top-0 z-10 flex h-[57px] items-center gap-1 border-b bg-background px-4">
                    <h1 className="text-xl font-semibold">Lingofi Chat</h1>
                    <Drawer>
                ...
                <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
                    <div className="relative flex h-full min-h-[50vh] flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
                        ...
                        <div className="h-96 flex-1 overflow-y-auto my-4 p-2">
